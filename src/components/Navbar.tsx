    ...
    return (
        <>
                    ...
                    <button className='bg-primary rounded-md cursor-pointer text-text hover:opacity-85 py-2 px-8'>
                        {user ?
                            <div className='flex items-center gap-2'>
                                <Image className='rounded-full ' width={25} height={25} alt='profile' src={user.user_metadata.avatar_url || '/user.png'} />
            ...
            <div className={`h-screen fixed md:hidden flex flex-col  items-center bg-black w-full ${open === false && "hidden"}`}>
                ...
                <ul className='flex flex-col w-full items-center mt-10 mb-16 gap-5'>
                ...
                <Link href={user ? "/dashboard" : "/login"} className='w-full  flex'>
                    <button className='bg-primary w-full text-center rounded-md cursor-pointer text-text hover:opacity-85 py-2 px-8'>
                        {user ?
