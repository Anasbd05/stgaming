...
const Hero = () => {
    return (
        <div className='h-screen mx-auto flex flex-col items-center  py-10 md:py-12 w-full lg::py-16  '>
            ...
            <p className='text-sm my-5 max-w-xl text-center '>Turn messy or empty rooms into epic gaming spaces in seconds. Upload a photo and let AI create the ultimate setup for you!</p>
